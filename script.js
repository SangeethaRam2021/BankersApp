...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    alert("Something wrong with entered details");
  }
});
...
btnTransfer.addEventListener("click", function (e) {
  ...
  if (
    amount > 0 &&
    (receiverAcc ? true : alert("Enter corrcet username")) &&
...
btnLoan.addEventListener("click", function (e) {
  ...
  if (
    ...
    alert("Your not eligible for the Loan Amount");
  }
...
btnClose.addEventListener("click", function (e) {
  ...
  if (
    ...
    alert("Enter your Username & Pin accurately");
  }
...
amountInput.min = 0; // Minimum value (start from 0)

// Optional: Set an initial value
// amountInput.value = 0; // Initial value (you can change this as needed)
